...
function ns.RegisterLDB(addon)
    ...
    local function onEnter(frame)
        ...
        local d = ns.db
        if d then
            GameTooltip:AddLine("Status: " .. (d.enabled and "|cff66dd66On|r" or "|cffff5555Off|r"), 1, 1, 1)
            ...
            local powder = ns.GetArcanePowderCount()
            GameTooltip:AddLine("Arcane Powder: |cff" .. ns.PowderColorHex(powder) .. powder .. "|r", 1, 1, 1)
        end
        GameTooltip:AddLine(" ")

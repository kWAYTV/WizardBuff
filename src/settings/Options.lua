...
function ns.RegisterOptions(addon)
    ...
    local function profileList(excludeCurrent)
        return function()
            local out, cur = {}, addon.db:GetCurrentProfile()
            for _, name in pairs(addon.db:GetProfiles({})) do
                if not (excludeCurrent and name == cur) then out[name] = name end
            end
            return out
        end
    end
    ...
    local options = {
        ...
        args = {
                    ...
                    display = {
                        ...
                        args = {
                            ...
                            showDragHandle = {
                                ...
                                desc = "Bar above the HUD for dragging and quick actions",
                                order = 5, width = "full",
                                set = function(_, v)
                            ...
                            minimapHide = {
                                type = "toggle", name = "Hide minimap icon",
                                order = 6, width = "full",
            ...
            appearance = {
                ...
                args = {
                    ...
                    combat = {
                        ...
                        args = {
                            hideHudInCombat = {
                                ...
                                desc = "Reduce opacity during combat",
                                order = 1, width = "full",
                            },
                        },
                    },
                    position = {
                        ...
                        args = {
                            resetPosition = {
                                type = "execute", name = "Reset position to center",
                                ...
                                func = function()
                                    ...
                                    if addon.db.profile then addon.db.profile.hudPos = nil end
                                end,
                            },
                        },
                    },
            ...
            buffs = {
                ...
                args = {
                    selfBuffs = {
                        order = 1, type = "group", name = "Self / Auto (left button)", inline = true,
                        args = {
                            buffArmor = {
                                type = "toggle", name = "Armor", order = 1, width = 1.0,
                            },
                            armorType = {
                                type = "select", name = "Armor type", order = 2, width = 1.0,
                            ...
                            bubbleType = {
                                type = "select", name = "Shield type", order = 5, width = 1.0,
                    ...
                    groupBuffs = {
                        order = 2, type = "group", name = "Group (middle button)", inline = true,
                        args = {
                            buffIntellect = {
                                type = "toggle", name = "Intellect", order = 1, width = 1.0,
                            },
                            useArcaneBrilliance = {
                            ...
                            buffPets = {
                                type = "toggle", name = "Buff pets", order = 3, width = "full",
                                disabled = function() return not addon.db.profile.buffIntellect end,
                            },
                        },
                    },
                    refreshGuard = {
                        ...
                        args = {
                            ...
                            refreshFloorSec = {
                                type = "range", name = "Min remaining (seconds)",
                    ...
                    manage = {
                        ...
                        args = {
                            ...
                            new = {
                                ...
                                set = function(_, v)
                                    v = ns.Trim(v)
                                    if v ~= "" then addon.db:SetProfile(v); refresh() end
                                end,
                            },
                            copy = {
